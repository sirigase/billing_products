...
if (r == true) {
  txt = "You pressed OK!";
  window.location.href = "DeleteInvoice.php?invno="+x+"&page="+s+"&p=r";
...
<div class="row">
    ...
    ?>
                    ...
                    <?php
                      $conn = new mysqli($servername, $username, $password, $dbname);
                        ...
                        //--------------------------------------------------------------------------
           $results_per_page = $rretail;  
      $query = "select *from transaction WHERE saletype='delivery'";  
    ...
    $page_first_result = ($page-1) * $results_per_page;  
     $query = "SELECT *FROM transaction WHERE saletype='delivery' order by INVOICENO DESC LIMIT " . $page_first_result . ',' . $results_per_page;  
    $result = mysqli_query($conn, $query);
    ...
    $no++;
          ...
          <thead>   <tr>
              ...
              <th>Delete</th>  
                           ...
                           //  echo "<td><a href=DeleteInvoice.php?invno=". $row["invoiceno"]. "&page=".$page."&p=r>Delete</a></td></tr>";
                             $no++;
                             }
                             } else {
                             echo "Zero Invoices in Delivery";
                              }
    //------------------------------------------------------------------
     echo "</table><br><p align=left>Page:&nbsp;";
    for($page = 1; $page<= $number_of_page; $page++) {  
        echo '<a href = "ListDelivery.php?s=0&page=' . $page . '">' . $page . ' </a>&nbsp;&nbsp;';  
    }
    echo "</p>";
    //------------------------------------------------------------------
                     $conn->close();
